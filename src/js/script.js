...
const bannerItems = [
  {
    ...
    titulo: "Torne-se o Herói do Seu Próximo Evento",
    descricao: "Qual herói você vai escolher hoje?"
  },
  {
    image: "./src/assets/slide2.jpg",
    titulo: "Detalhes que Fazem Você Virar Lenda",
    descricao: "Modelagens premium, tecidos confortáveis e acabamento fiel aos filmes"
  },
  {
    image: "./src/assets/slide3.jpg",
    titulo: "Coleção Exclusiva — Edição Limitada",
    descricao: "Fantasias dos heróis mais icônicos com disponibilidade limitada."
  }
];
  ...
  const { value: formValues } = await Swal.fire({
    ...
    preConfirm: () => {
      ...
      if (username === "admin" && password === '1234') {
        ...
        Swal.showValidationMessage('Por favor, digite o nome de usuário e senha corretos');
        return false;
      }
    },
  });
